...
- **Color palettes** - every overlay color (lines, labels, snap markers,
  construction plane) has a color picker, organized into named palettes: four
  shipped ones (Red, Green, Blue, Contrast) plus your own, all editable,
  persisted across sessions. Switch quickly via the window's **Palette** menu to
